...
# ==============================================================================
# Microsoft Connected Cache (MCC) GA Migration Script v3.2
#
# Location: Chicago, IL (Production)
# Node ID:  d702944d-e2d5-48d1-a4f9-d4e0e3f04930
#
# Description:
...
#   9. Waits for the container to initialize, then restarts it to complete the migration.
#
# ==============================================================================
...
CACHE_NODE_ID="d702944d-e2d5-48d1-a4f9-d4e0e3f04930"
CUSTOMER_KEY="a329105f-1c09-46ce-9f6b-c5a9dedfa207"
REGISTRATION_KEY="acdf2efb-a869-4645-b3b7-3d8f3d36486d"
...
echo "================================================="
echo "Starting MCC GA Migration for Production Chicago Node"
echo "================================================="
